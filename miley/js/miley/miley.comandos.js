...
if(val2 == "dois") {valor2 = 2};
	...
	var dialog_true = function() {mileyConvLog(); d.getElementById("resposta").value = "Certo, "+gen+". Aqui está o histórico de conversa."; voz();}; // Mostra o histórico de conversação da sessão
	var dialog_false = function() {mileyConvLogClose();  d.getElementById("resposta").value = "Entendido. Já ocultei."; voz();}; // Esconde o histórico de conversação da sessão
