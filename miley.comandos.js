...
if (annyang) {
	...
	var dialog_true = function() {dialogo.style.display = "block"; resposta.value = "Certo. Aqui está nosso histórico de conversa."; voz();}; // Mostra o histórico de conversação da sessão
	var dialog_false = function() {dialogo.style.display = "none";  resposta.value = "Entendido. Ocultei nosso histórico de conversa."; voz();}; // Esconde o histórico de conversação da sessão
	var alfa = function() {self.focus();};

// Navegação nas páginas do Facebook
	var fb = function() {abrirFb = w.open('http://www.facebook.com/', 'fb', 'width=1400, height=640, top=25, left=0'); resposta.value = "Tudo bem. Estou abrindo sua rede social, "+gen+" "+nome+"."; voz();};
	var fbrec = function() {abrirFb = w.open('http://www.facebook.com/?sk=h_chr', 'fb', 'width=1400, height=640, top=25, left=0'); resposta.value = "Okey. Mostrando as publicações mais recentes do feicebook."; voz();};
	var fbpop = function() {abrirFb = w.open('http://www.facebook.com/?sk=h_nor', 'fb', 'width=1400, height=640, top=25, left=0'); resposta.value = "Okey. Mostrando as publicações mais populares do feicebook."; voz();};
	var fbperfil = function() {abrirFb = w.open('http://www.facebook.com/profile.php', 'fb'); resposta.value = "Tudo bem. Estou abrindo seu perfil do feicebook, "+nome+"."; voz();};
	var fbalbum = function() {abrirFb = w.open('http://www.facebook.com/photos.php', 'fb'); resposta.value = "Aguarde. Vou abrir suas fotos do feicebook."; voz();};
	var fbmensagens = function() {abrirFb = w.open('http://www.facebook.com/messages', 'fb'); resposta.value = "Vou tentar abrir suas mensagens."; voz();};
	var fbnotificacoes = function() {abrirFb = w.open('http://www.facebook.com/notifications.php', 'fb'); resposta.value = "Certo. Estou abrindo suas notificações."; voz();};
...
// Pesquisa global nos navegadores mais conhecidos - Google, Bing, Yahoo
	...
	resposta.value = "Tá bom. Vou procurar nos melhores mecanismos de buscas por "+algo+"."; voz();};

var g1 = function(algo) {abrirWindowG1 = w.open('http://g1.globo.com/', 'g1', 'width=1400, height=640, top=25, left=0'); resposta.value = "Okey. Vou abrir o G1."; voz();};
// Pesquisa individual - Google, Bing, Yahoo
	// Google
	var google = function(algo) {abrirWindowG = w.open('http://google.com/', 'google', 'width=1400, height=640, top=25, left=0'); resposta.value = "Okey. Vou abrir o Google."; voz();};
	var pgoogle = function(algo) {abrirWindowG = w.open('http://google.com/#q='+algo, 'google', 'width=1400, height=640, top=25, left=0'); resposta.value = "Okey. Vou procurar por "+algo+" no Google."; voz();};
	// Wikipédia
	var pwiki = function(algo) {abrirWindowW = w.open('http://pt.wikipedia.com/wiki/'+algo, 'wiki', 'width=1400, height=640, top=25, left=0'); resposta.value = "Vamos ver na Wikipédia."; voz();};
	// Bing
	var bing = function(algo) {abrirWindowB = w.open('http://bing.com/', 'bing', 'width=1400, height=640, top=25, left=0'); resposta.value = "Certo. Vou abrir o Bing."; voz();};
	var pbing = function(algo) {abrirWindowB = w.open('http://bing.com/search?q='+algo, 'bing', 'width=1400, height=640, top=25, left=0'); resposta.value = "Certo. Vou usar o Bing para fazer a busca."; voz();};
	...
	// Yahoo!
	var yahoo = function(algo) {abrirWindowY = w.open('http://br.yahoo.com/', 'yahoo', 'width=1400, height=640, top=25, left=0'); resposta.value = "Okey. Vou abrir o Yahoo."; voz();};
	var pyahoo = function(algo) {abrirWindowY = w.open('http://br.search.yahoo.com/search;_ylt=Anmgv8ykk.JD03hZwN3Ah2eU7q5_?p='+algo+'&toggle=1&cop=mss&ei=UTF-8&fr=yfp-t-403&fp=1', 'yahoo', 'width=1400, height=640, top=25, left=0'); resposta.value = "Okey. Vou procurar por "+algo+" no Yahoo."; voz();};
	// YouTube
	...
	var pyoutube_t = function(video) {abrirWindowYt = w.open('http://youtube.com/results?search_query=allintitle:'+video, 'yt'); resposta.value = "Estou procurando só pelo título dos vídeos."; voz();};

	var escrever = function(repeat) {texto.value = repeat; _EaDsVr();};

// A variável "perguntar" e suas variantes retornam um ponto de interrogação ao final da frase.
	var perguntar = function(repeat) {texto.value = repeat+"?"; /* A variável perguntar_x adiciona uma interrogação ao final da frase */ _EaDsVr();};
	var perguntar_qual = function(repeat) {texto.value = "Qual "+repeat+"?"; _EaDsVr();};
	var perguntar_como = function(repeat) {texto.value = "Como "+repeat+"?"; _EaDsVr();};
	var perguntar_pq = function(repeat) {texto.value = "Por que "+repeat+"?"; _EaDsVr();};
	var perguntar_oque = function(repeat) {texto.value = "O que "+repeat+"?"; _EaDsVr();};
	var perguntar_quantos = function(repeat) {texto.value = "Quantos "+repeat+"?"; _EaDsVr();};
	var perguntar_quando = function(repeat) {texto.value = "Quando "+repeat+"?"; _EaDsVr();};
	var perguntar_quem = function(repeat) {texto.value = "Quem "+repeat+"?"; _EaDsVr();};
	var perguntar_doque = function(repeat) {texto.value = "Do que "+repeat+"?"; _EaDsVr();};

// As variáveis "falar_x" permitem que o usuário mantenha uma conversa mesmo estando no modo de comandos
	var falar_eu = function(repeat) {texto.value = "Eu "+repeat; _EaDsVr();};
	var falar_tu = function(repeat) {texto.value = "Tu "+repeat; _EaDsVr();};
	var falar_vc = function(repeat) {texto.value = "Você "+repeat; _EaDsVr();};
	var falar_ele = function(repeat) {texto.value = "Ele "+repeat; _EaDsVr();};
	var falar_nohs = function(repeat) {texto.value = "Nós "+repeat; _EaDsVr();};
	var falar_vcs = function(repeat) {texto.value = "Vocês "+repeat; _EaDsVr();};
	var falar_eles = function(repeat) {texto.value = "Eles "+repeat; _EaDsVr();};
// Artigos definidos
	var falar_o = function(repeat) {texto.value = "O "+repeat; _EaDsVr();};
	var falar_a = function(repeat) {texto.value = "A "+repeat; _EaDsVr();};
	var falar_os = function(repeat) {texto.value = "Os "+repeat; _EaDsVr();};
	var falar_as = function(repeat) {texto.value = "As "+repeat; _EaDsVr();};
// Artigos indefinidos
	var falar_um = function(repeat) {texto.value = "Um "+repeat; _EaDsVr();};
	var falar_uma = function(repeat) {texto.value = "Uma "+repeat; _EaDsVr();};
	var falar_uns = function(repeat) {texto.value = "Uns "+repeat; _EaDsVr();};
	var falar_umas = function(repeat) {texto.value = "Umas "+repeat; _EaDsVr();};

	var falar_pq = function(repeat) {texto.value = "Por que "+repeat; _EaDsVr();};
	var falar_que = function(repeat) {texto.value = "Que "+repeat; _EaDsVr();};
	var falar_oi = function(repeat) {texto.value = "Oi"; _EaDsVr();};
	var falar_ola = function(repeat) {texto.value = "Olá"; _EaDsVr();};
	var falar_obrigado = function(repeat) {texto.value = "Obrigado"; _EaDsVr();};
	var falar_obrigada = function(repeat) {texto.value = "Obrigada"; _EaDsVr();};
	var falar_eh = function(repeat) {texto.value = "É "+repeat; _EaDsVr();};
	var falar_meu = function(repeat) {texto.value = "Meu "+repeat; _EaDsVr();};
	var falar_minha = function(repeat) {texto.value = "Minha "+repeat; _EaDsVr();};
	var falar_de = function(repeat) {texto.value = "De "+repeat; _EaDsVr();};
	var falar_e = function(repeat) {texto.value = "E "+repeat; _EaDsVr();};
	var falar_eai = function(repeat) {texto.value = "E aí "+repeat; _EaDsVr();};
	var falar_nao = function(repeat) {texto.value = "Não "+repeat; _EaDsVr();};
	var falar_muito = function(repeat) {texto.value = "Muito "+repeat; _EaDsVr();};
	var falar_isso = function(repeat) {texto.value = "Isso "+repeat; _EaDsVr();};
	var falar_isto = function(repeat) {texto.value = "Isto "+repeat; _EaDsVr();};
	var falar_repete = function(repeat) {texto.value = "Repete "+repeat; _EaDsVr();};
	var falar_fala = function(repeat) {texto.value = "Fala "+repeat; _EaDsVr();};
	var falar_tudo = function(repeat) {texto.value = "Tudo "+repeat; _EaDsVr();};
	var falar_em = function(repeat) {texto.value = "Em "+repeat; _EaDsVr();};
	var falar_diz = function(repeat) {texto.value = "Diz "+repeat; _EaDsVr();};
	var falar_diga = function(repeat) {texto.value = "Diga "+repeat; _EaDsVr();};
	var falar_mas = function(repeat) {texto.value = "Mas "+repeat; _EaDsVr();};
	var falar_ate = function(repeat) {texto.value = "Até "+repeat; _EaDsVr();};
	var falar_mediz = function(repeat) {texto.value = "Me diz "+repeat; _EaDsVr();};
	var falar_mediga = function(repeat) {texto.value = "Me diga "+repeat; _EaDsVr();};
	var falar_mefala = function(repeat) {texto.value = "Me fala "+repeat; _EaDsVr();};
	var falar_mefale = function(repeat) {texto.value = "Me fale "+repeat; _EaDsVr();};
	var falar_tbm = function(repeat) {texto.value = "Também "+repeat; _EaDsVr();};
...
annyang.addCallback('resultNoMatch', function() {texto.value = "Comando desconhecido."; _EaDsVr();
});
annyang.addCallback('errorPermissionDenied', function() {texto.value = permissaoNegada; _EaDsVr();
});
