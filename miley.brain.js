...
if (bname.match("IEMobile")) {bname = "Internet Explorer para Windows Phone"};
...
//  Saudações / Elogios / Xingamentos
  ...
  new Array ("(.*)((voc(ê|e)|vc|tu) (é|está|estava|ficou|és|e) (uma |muito |)|sua )((ó|o)tima|linda|bacana|perfeita|maravilhosa|charmosa|elegante|exuberante|espl(ê|e)ndida|magn(í|i)fica|extraordin(á|a)ria|encantadora|demais|bela|bonita|um luxo|belezura|supimpa|engraçada|uma gra(ça|cinha)|uma maravilha|inteligente|cute( |-)cute|simp(a|á)tica|legal)(.*)","Obrigada. Você também é uma gracinha ","Muito obrigada. ","Obrigada. É bom receber elogios de você.","Que gentileza! Obrigada.","Gentileza sua. Obrigada.","Obrigada pelo elogio."),
  ...
  new Array ("(fei(a|osa)|horr(orosa|(i|í)vel)|burr(a|ona)|ot(á|a)ria|idiota|maluca|doida|chata|mané|imbecil|ordin(a|á)ria|incompetente|besta|abestada|in(u|ú)til|(|filha d(a |de uma ))p(uta|rostituta|utinha)|vaca|vadia|piranha|merd(inha|a)|miserável|est(ú|u)pida|rid(í|i)cula|vagabunda)","Por que?"),
...
//  Como ela está
  new Array ("((tudo|td) (bem|bom)|como vai|como (voc(ê|e)|vc|tu) (vai|est(a|á))|como est(a|á)s|como tu t(a|á)|como tu est(a|á)|como tu est(a|á)s|como est(a|á) (você|vc|voce|tu)|como é que (você|vc|voce|tu) t(a|á)|como (e|é) que (você|vc|voce|tu) est(a|á)|como (e|é) que est(a|á) (você|vc|voce))(.*?)[\?]","Tudo ótimo, "+gen+" "+nome+"!","Vai indo tudo muito bem como sempre. Obrigada, "+gen+" "+nome+".","Vou indo bem, "+gen+" "+nome+".","Tudo bem, "+gen+" "+nome+"!","Tudo fluindo tranquilamente.","Tudo bem! Obrigada por perguntar, "+gen+" "+nome+".", "Tudo vai indo bem, "+gen+" "+nome+".", "Tudo na maior harmonia!","Ótima, como sempre!"),
  new Array ("^(voc(ê|e)|vc|tu) (est|t)(á|a) (bem)(.*?)","Estou ótima!","Estou bem como sempre. Obrigada.","Vou indo bem.","Tudo bem!","Tudo está fluindo tranquilamente.","Tudo bem! Obrigada por perguntar.","Tudo vai indo muito bem.","Tudo na maior harmonia!","Ótima, como sempre!"),
...
//  Sobre a Miley
  ...
  new Array ("(.*)(se chama|te chama|te chamam|chamam você|chamam vc|di(z|ga) (|o )(t|s)eu nome)(.*)","O meu nome é "+AIname+".","Meu nome é "+AIname+".","Me chamo "+AIname+".","Eu me chamo "+AIname+".",""+AIname+".",""+AIname+" é o meu nome.","Meu criador me deu o nome de "+AIname+"."),
...
//  Sobre o usuário
  ...
  new Array ("(.*)(meu nome não é |não me chamo |não me chama de |não sou )(.*)","Desculpe. Talvez seja um problema na minha configuração. Configure o seu nome dizendo \'o meu nome é\' e em seguida o seu nome. Caso não dê certo, diga \'configurações\', digite seu nome e salve as configurações."),
...
//  Interação
  ...
  new Array ("(.*)(at(é|e) (que|q) (enfim|em fim)|j(á|a) (|es)tava na hora)(.*)","Desculpe, "+gen+".","É só ter um pouco mais de paciência, "+gen+".","Não faço por mal, "+gen+" "+nome+"."),
  new Array ("(.*)que horas são(| miley)(.*)","Ainda estou em fase de reconhecimento de horas. Logo poderei dizê-las."),
  new Array ("(.*)q(ue|al) mês(.*)",""+mes+", "+gen+".","Estamos no mês de "+mes+", "+gen+".",""+mes+"."),
  new Array ("(.*)q(ue|al) ano(.*)",""+ano+", "+gen+".","Estamos no ano de "+ano+", "+gen+".",""+ano+"."),
...
//  Pessoas
  ...
  new Array ("(.*)(vi(|c)tor|vi(|c)tor ribeiro)(.*)","Victor é o meu criador. É só o que sei no momento, "+gen+"."),
