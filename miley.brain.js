...
var version = "1.0.8";  // * Versão da I.A.
...
//  Ela não sabe responder ou não responde
  ...
  new Array (
  "o que é (.*?)[\?]",
  "Hum, não sei responder a isso ainda... \'$1\' é uma coisa que ainda não sei o que é.",
  "$1? Boa pergunta...",
  "\'$1\'?... Não sei ainda.",
  "Desculpe, não sei ainda o que é $1.",
  "Perdão, mas isso eu não sei responder ainda.",
  "Ainda não sei responder o que é $1.",
  "Não sei o que \'ser\' $1 ainda.",
  "Ainda não sei o que é $1, mas vou aprender!"
  ),
  new Array (
  "quanto é (.*?)[\?]",
  "$1? Boa pergunta...",
  ...
  "Não entendi. Você pode dizer \'ajuda\' para saber o que pode conversar comigo.",
  "Desculpe. Não entendi.",
  "Eu não entendi.",
  "Meu criador ainda não me ensinou sobre isso.",
  "Não entendi.",
