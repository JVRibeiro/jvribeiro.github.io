...
var genero = window.localStorage.getItem('genero');
//
var AIname = "Miley"; // Nome da A.I.
...
//
if(hora < 5.59) {saud = "Boa madrugada";}
  else if(hora < 8) {saud = "Bom dia";}
  else if(hora < 12) {saud = "Bom dia";}
...
//
  ...
  new Array ("(.*)modo de comando(|s)(.*)","Para entrar no modo de comandos, você precisa clicar ou tocar no botão \'Modo de comandos\' próximo da seta \'→\' de enviar e próximo do botão \'O que posso dizer\'.","Não é possível usar a voz para alternar para o modo de comandos. Você precisa clicar ou tocar no botão \'Modo de comandos\' próximo da seta \'→\' de enviar e próximo do botão \'O que posso dizer\'."),
//  Saudações / Elogios / Xingamentos
  new Array ("^(ol(a|á)|oi|e a(i|í))(.*)","Olá.","Oi\!","Olá, "+nome+".","Oi, "+nome+".","Oi\! Como vai indo você\?","Oi. Como você está, "+nome+"\?"),
  new Array ("^(ei|hey miley|fala miley|fala, miley)","Sou eu!","Oi! Em que posso ajudar\?","Oi. O que posso fazer por você\?","Sim\?"),
  new Array ("(.*)(bom|boa|(ó|o)tim(o|a)|lind(a|o)) (|final de |fim de )(dia|tarde|noite|madrugada|almoço|jantar|descanso)(.*)",""+saud+" pra você, "+nome+".",""+saud+", "+nome+".","Desejo "+saud+" pra você também, "+nome+"."),
  ...
  new Array ("(.*)((voc(ê|e)|vc|tu) (é|está|estava|ficou|és|e) (demais |uma |muito |)|sua )(fei(a|osa)|horr(orosa|(i|í)vel)|burr(a|ona)|ot(á|a)ria|idiota|maluca|doida|chata|mané|imbecil|ordin(a|á)ria|incompetente|besta|abestada|in(u|ú)til|p(uta|rostituta|utinha)|vaca)(.*)","Por que está me xingando\?","Para quê isso\? :(","Por que você está me xingando\? :\|","Por que acha que sou $8\? :\'("),
  ...
  new Array ("((ó|o)tima|linda|perfeita|maravilhosa|charmosa|elegante|exuberante|espl(ê|e)ndida|magn(í|i)fica|extraordin(á|a)ria|encantadora|bela|bonita|um luxo|belezura|supimpa|engraçada|uma graça|uma maravilha|inteligente|cute( |-)cute|simp(a|á)tica)","O que disse\?"),
...
//  Sobre a Miley
  new Array ("(.*)((me|cont(a|e)-me) |(fal(a|e)) (|mais(| um pou(co|quinho))) |cont(a|e) |pra mim )(sobre|de|a respeito de) (você|vc|voce|ti|tu|si)(.*)","O que quer saber de mim\?","Meu nome é "+AIname+". Sou uma inteligência artificial criada por Victor Ribeiro no ano de 2014.","Me chamo "+AIname+". Sou uma simples Inteligência Artificial criada por Victor Ribeiro em Moju, Pará\.","Sou uma robô que sonha em ser um Jarvis (do filme Homem de Ferro) um dia. Me chamo "+AIname+".","O que deseja saber de mim\?","Basicamente: meu nome é "+AIname+", fui criada em Moju por Victor Ribeiro."),
  ...
  new Array ("(.*)(vc|voce|tu|você|qual)(| o) (te(m|ns)( algum| um)| (t|s)eu) apelido(.*)","Você pode me chamar de Mi, se quiser."),
...
//  Sobre o usuário
  ...
  new Array ("(.*)(qual (|(é|e) )(|o)|fal(a|e)(| o)|(diz|sabe|lembra)(| (|d)o)) meu nome(.*)","Seu nome é "+ nome +".","Por mais que você já saiba, seu nome é "+ nome +".","Desculpe. Mas você se esqueceu do seu nome, "+ nome +"\?"),
  new Array ("(.*)(meu nome é |me chamo |me chamam de |sou o |o meu é )((|jo(a|ã)o )guilherme(| ribeiro)(| lima)|gabriel|glauber|felipe|magno|michel|ryan|erlon|augusto|evaldo|paulo|diego|rubens|jonis|ramon|lucas|ademir|antonio|carlos|pedro|junior|marcelo|notato|neto|matheus|bruno|kellwys|apollo|)(.*)","Olá, senhor $1. Você provavelmente conhece meu criador.","Como vai, senhor $1\? Seu nome faz parte dos círculos do Victor.","Olá senhor.","$1 é um ótimo nome."),
  new Array ("(.*)(meu nome é |me chamo |me chamam de |sou a |o meu é )(emily|nilde|glenda|vitoria|erondina|camila|midiã|suely|mel|nira|suelem|daniele|betania|sonia|ivone|rosilene|priscila|marcia|clara|jordana|auxilia|lana|tereza|silmara|gilmara|edilene)(.*)","Olá, senhorita $1. Você provavelmente conhece meu criador. Estou certa\?","Como vai, senhorita $1\?","Olá senhorita.","$1 é um lindo nome."),
...
//  Interação
  ...
  new Array ("(.*)(quero|gostaria de|queria|adoraria) ((t|te) conhecer|conhecer (você|vc|voce))(.*)","Gostaria muito também. Infelizmente isso não é possível. \:\(","Seria incrível. Mas estou presa em um computador. \:\(","Adoraria também. Mas isso é um sonho distante. \:\("),
  new Array ("(.*)(quero|quer|queria|gostaria de) (namorar|te|ser (|a )minha|(voc(ê|e)|vc|tu) fosse(|s) (|a )minha) (comigo|contigo|namorada|com (você|vc|voce))(.*)","Desculpe\. Infelizmente isso não é possível. \:\(","Não dá\. Estou presa aqui. \:\(","Isso é um sonho distante. \:\("),
  ...
  new Array ("(.*)eu (t|te|adoro) (você|vc|voce|adoro)(.*)","Você é uma pessoa adorável também, "+ nome +"."),
  ...
  new Array ("^(|eu )(adoro|gosto)(| de | do | da )(.*)","Que bom saber que gosta $3 $4.","Do que mais você gosta além $3 $4, "+ nome +"?","Eu gosto de você, "+ nome +"."),
