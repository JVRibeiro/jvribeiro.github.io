...
! function() {
  ...
  window.MaterialMenu = d, d.prototype.Constant_ = {
    ...
    if (this.element_ && this.forElement_) {
      ...
      this.element_.classList.contains(this.CssClasses_.UNALIGNED) || (this.element_.classList.contains(this.CssClasses_.BOTTOM_RIGHT) ?

        // Original: this.container_.style.right = s.right - t.right + "px", this.container_.style.top = this.forElement_.offsetTop + this.forElement_.offsetHeight + "px"
        // Modification: this.container_.style.right = "5px", this.container_.style.top = "-40px"
        (this.container_.style.right = "5px", this.container_.style.top = "-40px") :
