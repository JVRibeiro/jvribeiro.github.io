...
a},500)};genderSelect_male=function(){setTimeout(function(){$(".cs-select").hasClass("cs-active")?$(".cs-select").hasClass("cs-active")&&(console.log("else if"),$('.cs-options ul li[data-value="masculino"]').click(),bootstrap.title.animation("fadeInUp","fadeOut"),bootstrap.title.text('<span class="title_Med">Continuando...</span>'),ai.say("Certo."),window.setTimeout(function(){treatmentFirstSetting()},1500)):(console.log("if"),$(".cs-placeholder").click(),window.setTimeout(function(){$('.cs-options ul li[data-value="masculino"]').click()},
700),bootstrap.title.animation("fadeInUp","fadeOut"),bootstrap.title.text('<span class="title_Med">Continuando...</span>'),ai.say("Certo."),window.setTimeout(function(){$(intScr_confirmButton).click()},1500))},100)};genderSelect_female=function(){$(".cs-select").hasClass("cs-active")?($('.cs-options ul li[data-value="feminino"]').click(),bootstrap.title.animation("fadeInUp","fadeOut"),bootstrap.title.text('<span class="title_Med">Continuando...</span>'),ai.say("Certo."),setTimeout(function(){treatmentFirstSetting()},
1500)):($(".cs-placeholder").click(),window.setTimeout(function(){$('.cs-options ul li[data-value="feminino"]').click()},700),bootstrap.title.animation("fadeInUp","fadeOut"),bootstrap.title.text('<span class="title_Med">Continuando...</span>'),ai.say("Certo."),window.setTimeout(function(){$(intScr_confirmButton).click()},1500))};defaultCommands={ok:function(){"permissions"===actualScreen?($(intScr_confirmButton).click(),notification.create("success","O microfone est\u00e1 funcionando corretamente!",
"",5E3)):ai.say("...")},"(pode)( )me cham(a)(e)(r) de *nome":function(a){user.name=a;Reload();salvarDados();ai.say("Ol\u00e1, "+a+"!")},"me chamo *nome":function(a){user.name=a;Reload();salvarDados();ai.say("Ol\u00e1, "+a+"!")},"meu nome \u00e9 *nome":function(a){user.name=a;Reload();salvarDados();ai.say("Ol\u00e1, "+a+"!")},"(Sophia)(Sofia) defin(e)(a) a *algo":definir,"(Sophia)(Sofia) defin(e)(a) o *algo":definir,"(Sophia)(Sofia) defin(e)(a) as *algo":definir,"(Sophia)(Sofia) defin(e)(a) os *algo":definir,
"(Sophia)(Sofia) defin(e)(a) *algo":definir,"(Sophia)(Sofia) defin(e)(a) :algo":definir,"(Sophia)(Sofia) quem \u00e9 *algo (Sophia)(Sofia)":definir,"(Sophia)(Sofia) quem foi *algo (Sophia)(Sofia)":definir,"(Sophia)(Sofia) quem era *algo (Sophia)(Sofia)":definir,"(Sophia)(Sofia) o que \u00e9 o *algo (Sophia)(Sofia)":definir,"(Sophia)(Sofia) o que \u00e9 a *algo (Sophia)(Sofia)":definir,"(Sophia)(Sofia) o que \u00e9 um *algo (Sophia)(Sofia)":definir,"(Sophia)(Sofia) o que \u00e9 uma *algo (Sophia)(Sofia)":definir,
