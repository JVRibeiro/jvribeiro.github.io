if (annyang) {
  ...
  var fecharSophia = function() {
    $("#sophia-reply").html("Tchau tchau!");
    $("#log4").val("Tchau tchau!");
    voz();
  ...
  var fbrec = function(facebook) {
    abrirFb = window.open('https://www.facebook.com/?sk=h_chr', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=25, left=0');
    $("#sophia-reply").html(afirmativo + userRef + ". Mostrando as publicações mais recentes do Facebook.");
    $("#log4").val(afirmativo + userRef + "Okey. Mostrando as publicações mais recentes do feicebook.");
    voz(); /*saveHist()*/
  };
  var fbpop = function(facebook) {
    abrirFb = window.open('https://www.facebook.com/?sk=h_nor', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=25, left=0');
    $("#sophia-reply").html(afirmativo + userRef + ". Mostrando as publicações mais populares do Facebook.");
    $("#log4").val(afirmativo + userRef + "Okey. Mostrando as publicações mais populares do feicebook.");
    voz(); /*saveHist()*/
  };
  var fbperfil = function(facebook) {
    abrirFb = window.open('https://www.facebook.com/profile.php', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=25, left=0');
    $("#sophia-reply").html(afirmativo + userRef + ". Abrindo seu perfil" + userRef + ".");
    $("#log4").val(afirmativo + userRef + "Abrindo seu perfil.");
    voz(); /*saveHist()*/
  };
  var fbalbum = function(facebook) {
    abrirFb = window.open('https://www.facebook.com/photos.php', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=25, left=0');
    $("#sophia-reply").html(afirmativo + userRef + ". Vou abrir suas fotos.");
    $("#log4").val(afirmativo + userRef + "Aguarde. Vou abrir suas fotos.");
    voz(); /*saveHist()*/
  };
  var fbmensagens = function(facebook) {
    abrirFb = window.open('https://www.facebook.com/messages', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=25, left=0');
    $("#sophia-reply").html(afirmativo + userRef + ". Vou abrir suas mensagens.");
    $("log4").val(afirmativo + userRef + "Vou tentar abrir suas mensagens.");
    voz(); /*saveHist()*/
  };
  var fbnotificacoes = function() {
    fbNotifications();
    openNotifications();
  };


  var siteCom = function(algo) {
    abrirSite = window.open('http://' + algo + '.com', 'site', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Okey, " + gen + ". Vou abrir o " + algo + ".com.");
    voz(); /*saveHist()*/
  };
  var siteComBr = function(algo) {
    abrirSite = window.open('http://' + algo + '.com.br', 'site', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Okey, " + gen + ". Vou abrir o " + algo + ".com.br.");
    voz(); /*saveHist()*/
  };
  var siteOrg = function(algo) {
    abrirSite = window.open('http://' + algo + '.org', 'site', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Okey, " + gen + ". Vou abrir o " + algo + ".org.");
    voz(); /*saveHist()*/
  };
  var siteOrgBr = function(algo) {
    abrirSite = window.open('http://' + algo + '.org.br', 'site', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Okey, " + gen + ". Vou abrir o " + algo + ".org.br.");
    voz(); /*saveHist()*/
  };
  ...
  var p_global = function(algo) {
    ...
    $("#sophia-reply").html("Tá bom. Vou procurar nos melhores mecanismos de buscas por " + algo + ".");
    voz(); /*saveHist()*/
  };

  var g1 = function(algo) {
    abrirWindowG1 = window.open('http://g1.globo.com/', 'g1', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Vou abrir o G1.");
    voz(); /*saveHist()*/
  };
  // * Pesquisa individual - Google, Bing, Yahoo

  // * Google
  var google = function(algo) {
    abrirWindowG = window.open('http://google.com/', 'google', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Vou abrir o Google.");
    voz(); /*saveHist()*/
  };
  var pgoogle = function(algo) {
    abrirWindowG = window.open('http://google.com/search?q=' + algo, 'google', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Vou procurar por " + algo + " no Google, " + gen + ".");
    voz(); /*saveHist()*/
  };

  // * Wikipédia
  var pwiki = function(algo) {
    abrirWindowW = window.open('http://pt.wikipedia.org/wiki/' + algo, 'wiki', 'width=600, height=700, top=25, right=0');
  };
  ...
  */
  ...
  // * Bing
  var bing = function(algo) {
    abrirWindowB = window.open('http://bing.com/', 'bing', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Certo. Vou abrir o Bing.");
    voz(); /*saveHist()*/
  };
  var pbing = function(algo) {
    abrirWindowB = window.open('http://bing.com/search?q=' + algo, 'bing', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Certo. Vou usar o Bing para fazer a busca.");
    voz(); /*saveHist()*/
  };
  var pbing_img = function(algo) {
    abrirWindowB = window.open('http://bing.com/images/search?q=' + algo, 'bing', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Okey. Vou procurar no Bing algumas imagens de " + algo + ".");
    voz(); /*saveHist()*/
  };
  var pbing_vid = function(video) {
    abrirWindowB = window.open('http://bing.com/videos/search?q=' + video, 'bing', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Reuni alguns resultados de vídeos sobre " + video + ".");
    voz(); /*saveHist()*/
  };

  // * Yahoo!
  var yahoo = function(algo) {
    abrirWindowY = window.open('http://br.yahoo.com/', 'yahoo', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Okey. Vou abrir o Yahoo.");
    voz(); /*saveHist()*/
  };
  var pyahoo = function(algo) {
    abrirWindowY = window.open('http://br.search.yahoo.com/search;_ylt=Anmgv8ykk.JD03hZwN3Ah2eU7q5_?p=' + algo + '&toggle=1&cop=mss&ei=UTF-8&fr=yfp-t-403&fp=1', 'yahoo', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Okey. Vou procurar por " + algo + " no Yahoo.");
    voz(); /*saveHist()*/
  };

  // * YouTube
  var pyoutube = function(video) {
    abrirWindowYt = window.open('http://youtube.com/results?search_query=' + video, 'yt', 'width=1400, height=640, top=25, left=0');
    $("#sophia-reply").html("Consegui achar esses vídeos de " + video + " no YouTube.");
    voz(); /*saveHist()*/
  };
  var pyoutube_t = function(video) {
    abrirWindowYt = window.open('http://youtube.com/results?search_query=allintitle:' + video, 'yt');
    $("#sophia-reply").html("Estou procurando só pelo título dos vídeos.");
    voz(); /*saveHist()*/
  };
  ...
  var perguntar_qual = function(algo) {
    $("#user-input").val("Qual " + algo + "?");
  };
  var perguntar_como = function(algo) {
    $("#user-input").val("Como " + algo + "?");
  };
  var perguntar_pq = function(algo) {
    $("#user-input").val("Por que " + algo + "?");
  };
  var perguntar_oque = function(algo) {
    $("#user-input").val("O que " + algo + "?");
  };
  var perguntar_quantos = function(algo) {
    $("#user-input").val("Quantos " + algo + "?");
  };
  var perguntar_quando = function(algo) {
    $("#user-input").val("Quando " + algo + "?");
  };
  var perguntar_quem = function(algo) {
    $("#user-input").val("Quem " + algo + "?");
  };
  var perguntar_doque = function(algo) {
    $("#user-input").val("Do que " + algo + "?");
  };
  ...
  var fb_close = function() {
    abrirFb.close();
  };
  var pgoogle_close = function() {
    abrirWindowG.close();
  };
  var pbing_close = function() {
    abrirWindowB.close();
  };
  var pwiki_close = function() {
    abrirWindowW.close();
  };
  var pyahoo_close = function() {
    abrirWindowY.close();
  };
  var pyt_close = function() {
    abrirWindowYt.close();
  };
  var g1_close = function() {
    abrirWindowG1.close();
  };
  var ajuda_close = function() {
    abrirWindowA.close();
  };
  ...
  var commands = {
    ...
    */
    ...
    '(tenho uma) dúvida *algo': function(algo) {
      $("#user-input").val(algo + "?");
    },
    'tenho uma pergunta *algo': function(algo) {
      $("#user-input").val(algo + "?");
    },
    'e se eu (te)(lhe) perguntar *algo': function(algo) {
      $("#user-input").val(algo + "?");
    },
    ...
    '(abr)(e)(i)(r) (feed de notícias) (do) face(book) (*algo)': function(facebook) {
      abrirFb = window.open('https://www.facebook.com/', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=0, left=0');
      $('#log4').val('Abrindo Facebook...');
      voz();
      saveHist();
    },
    '(abr)(e)(i)(r) feed (do) (face)(book) (*algo)': function(facebook) {
      abrirFb = window.open('https://www.facebook.com/', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=0, left=0');
      $('#log4').val('Abrindo Facebook...');
      voz();
      saveHist();
    },
    '(abr)(e)(i)(r) mostra (o) (meu) feed (do) (face)(book) (por favor) (Sophia)(Sofia) (por favor)': function(facebook) {
      abrirFb = window.open('https://www.facebook.com/', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=0, left=0');
      $('#log4').val('Abrindo Facebook...');
      voz();
      saveHist();
    },
    '(abr)(e)(i)(r) volta pro feed (por favor) (*algo)': function(facebook) {
      abrirFb = window.open('https://www.facebook.com/', 'facebook', 'width=' + wdt + ', height=' + hgt + ', top=0, left=0');
      $('#log4').val('Abrindo Facebook...');
      voz();
      saveHist();
    ...
    '(agora) sai(r) (do) face(book) (aí) (pra mim) (por favor) (Sophia)(Sofia) (por favor)': function() {
      fbLogout();
    },
    ...
    */
    '(Sophia)(Sofia) o que significa (o) (s)(t)eu nome (Sophia)(Sofia)': function() {
  ...
  var commands2 = { // Editor de texto
    '(agora) (so)(ph)(f)(ia) leia (pra mim) (agora) (so)(ph)(f)(ia)': function() {
      $('#sophia-reply').html(documentVoiceTextEditor.value);
      $('#log4').val($('#sophia-reply').val());
      voz();
    },
    '(agora) (so)(ph)(f)(ia) lê (pra mim) (agora) (so)(ph)(f)(ia)': function() {
      $('#sophia-reply').html(documentVoiceTextEditor.value);
      $('#log4').val($('#sophia-reply').val());
      voz();
    },
    '(agora) (so)(ph)(f)(ia) ler (pra mim) (agora) (so)(ph)(f)(ia)': function() {
      $('#sophia-reply').html(documentVoiceTextEditor.value);
      $('#log4').val($('#sophia-reply').val());
      voz();
    },
    ...
    'ponto': function() {
      documentVoiceTextEditor.value += ". ";
    },
    'ponto parágrafo': function() {
      documentVoiceTextEditor.value += ". \n\n";
    },
    'ponto (em) seguida': function() {
      documentVoiceTextEditor.value += ". ";
    },
    ...
    'na outra linha': function() {
      documentVoiceTextEditor.value += " \n\n";
      document.getElementById('documentVoiceTextEditor').focus();
    },

    '(ponto de) interrogação': function() {
      documentVoiceTextEditor.value += "? ";
    },

    '(ponto de) exclamação': function() {
      documentVoiceTextEditor.value += "! ";
    },

    'dois pontos': function() {
      documentVoiceTextEditor.value += ": ";
    },

    'apaga(r)': function() {
      var lastIndex = documentVoiceTextEditor.value.lastIndexOf(" ");
      var str = documentVoiceTextEditor.value.substring(0, lastIndex);
      documentVoiceTextEditor.value = str;
    },
    'limpa(r) tudo': function() {
      documentVoiceTextEditor.value = "";
    },
    'apaga(r) tudo': function() {
      documentVoiceTextEditor.value = "";
    },
    'apaga(r) até (n)(a)(o)(em) *word': function(word) {
      var lastIndex = documentVoiceTextEditor.value.lastIndexOf(word);
      var str = documentVoiceTextEditor.value.substring(0, lastIndex);
      documentVoiceTextEditor.value = str;
    },
    'deleta(r) até (n)(a)(o)(em) *word': function(word) {
      var lastIndex = documentVoiceTextEditor.value.lastIndexOf(word);
      var str = documentVoiceTextEditor.value.substring(0, lastIndex);
      documentVoiceTextEditor.value = str;
    },
  ...
  */
  ...
  var commandsUserName = {
    ...
    'no': function() {
      ...
      $('#introducing-screen-conf-button').removeClass('animated zoomInUp').addClass('animated zoomOutDown');
    },
  ...
  */
  ...
  alert('Seu navegador não suporta todas as funcionalidades da Sophia.');
}
